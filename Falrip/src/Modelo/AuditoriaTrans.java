...
public class AuditoriaTrans {
    ...
    public AuditoriaTrans() {
    }

    public AuditoriaTrans(int idAuditoria, String usuarioApp, Timestamp fechaEvento, String tipoOperacion, String descripcion) {
